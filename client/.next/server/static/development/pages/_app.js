...
var NEXT_REDUX_STORE = 'NEXT_REDUX_STORE'; // get or create redux store depending on whether it's running on the client or the server
...
function getOrCreateStore(initialState) {
  ...
  if (!window[NEXT_REDUX_STORE]) {
    window[NEXT_REDUX_STORE] = Object(_store__WEBPACK_IMPORTED_MODULE_2__["initializeStore"])(initialState);
  }

  return window[NEXT_REDUX_STORE];
}

var withStore = function withStore(App) {
  return (
    /*#__PURE__*/
    function (_React$Component) {
      _inherits(AppWithStore, _React$Component);

      _createClass(AppWithStore, null, [{
        key: "getInitialProps",
        value: function () {
          var _getInitialProps = _asyncToGenerator(
          /*#__PURE__*/
          _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(appContext) {
            var response, users, reduxStore, appProps;
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://localhost:3000/api/people');

                  case 2:
                    response = _context.sent;
                    users = response.data.map(function (user) {
                      return _objectSpread({}, user, {
                        birthdate: moment__WEBPACK_IMPORTED_MODULE_4___default()(user.birthdate).format('YYYY-MM-DD')
                      });
                    });
      ...
      function AppWithStore(props) {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(AppWithStore).call(this, props));
      ...
      _createClass(AppWithStore, [{
        ...
        value: function render() {
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(App, _extends({
...
/* harmony default export */ __webpack_exports__["default"] = (withStore);
...
/* harmony import */ var _lib_withStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../lib/withStore */ "./lib/withStore.js");
...
/* harmony import */ var react_jss_lib_JssProvider__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! react-jss/lib/JssProvider */ "react-jss/lib/JssProvider");
...
function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_material_ui_core_CssBaseline__WEBPACK_IMPORTED_MODULE_6___default.a, null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_redux__WEBPACK_IMPORTED_MODULE_2__["Provider"], {
        store: reduxStore
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_lib_withStore__WEBPACK_IMPORTED_MODULE_3__["default"])(MyApp));
